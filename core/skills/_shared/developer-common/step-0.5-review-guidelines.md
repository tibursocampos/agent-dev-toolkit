...
| Need | Path |
|------|------|
| Layers / rings (ARCH = concentric / CA) | `{{TOOLKIT_ROOT}}/skills/_shared/dotnet-guidelines/clean-architecture.md` |
| Vertical slice (ARCH = VSA) | `{{TOOLKIT_ROOT}}/skills/_shared/dotnet-guidelines/vertical-slice.md` |
...
| Need | Path |
|------|------|
| Engineering core (not visual design) | `{{TOOLKIT_ROOT}}/skills/_shared/frontend-guidelines/frontend-practices.md` |
| FE folder layout (ARCH / CONTINUITY) | Prefer `{{TOOLKIT_ROOT}}/skills/_shared/frontend-guidelines/frontend-architecture.md` — not a full CA tree per framework |
| Markup / CSS / SCSS | `{{TOOLKIT_ROOT}}/skills/_shared/html-css-guidelines/` |
| Cross-stack tests | `{{TOOLKIT_ROOT}}/skills/_shared/frontend-guidelines/frontend-testing.md` |
| React | `{{TOOLKIT_ROOT}}/skills/_shared/react-guidelines/` |
| Angular | `{{TOOLKIT_ROOT}}/skills/_shared/angular-guidelines/` |
| Vue | `{{TOOLKIT_ROOT}}/skills/_shared/vue-guidelines/` |
| Blazor | `{{TOOLKIT_ROOT}}/skills/_shared/blazor-guidelines/` |
| Electron | `{{TOOLKIT_ROOT}}/skills/_shared/electron-guidelines/` |
| Vanilla / DOM | `{{TOOLKIT_ROOT}}/skills/_shared/javascript-guidelines/dom-patterns.md` |
