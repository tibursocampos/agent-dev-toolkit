...
Install path after sync: `{{TOOLKIT_ROOT}}/skills/_shared/developer-common/`
...
Follow `{{TOOLKIT_ROOT}}/skills/_shared/developer-common/step-3-branching.md`.
```
...
| Step | Rule / skill |
|------|----------------|
| 3 | `{{TOOLKIT_ROOT}}/rules/branch-validation.mdc` |
| 4 | `{{TOOLKIT_ROOT}}/rules/conventional-commits.mdc`, `commit` skill |
