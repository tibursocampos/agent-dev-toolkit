...
Paths after sync: `{{TOOLKIT_ROOT}}/skills/_shared/code-guidelines/`
...
Use `{{TOOLKIT_ROOT}}/skills/_shared/dotnet-guidelines/` - not `code-guidelines/languages/dotnet/` until v1.1.
