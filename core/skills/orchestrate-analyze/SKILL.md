...
| Process details, triage, NuGet, Must not | `{{TOOLKIT_ROOT}}/skills/orchestrate-analyze/reference.md` |
| Scorecard rubric (reuse) | `{{TOOLKIT_ROOT}}/skills/refine-story/reference.md` |
...
| Process steps / triage / NuGet / ARCH confirm / Must not | `{{TOOLKIT_ROOT}}/skills/orchestrate-analyze/reference.md` |
| Scorecard /100 → STORY | `{{TOOLKIT_ROOT}}/skills/refine-story/reference.md` |
