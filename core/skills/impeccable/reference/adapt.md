<!--
Adapted for agent-dev-toolkit from pbakaus/impeccable (Apache-2.0, Copyright 2025 Paul Bakaus).
Changed: harness has no engine launcher. Detector is `npx impeccable detect`. Do not run install, live, or hooks without an explicit user sim. Toolkit gates in core/policy/guardrails.md still apply.
-->
