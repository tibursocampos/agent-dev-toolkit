...
4. **Pull in any prior critique** (optional signal): This harness does not ship `critique-storage.mjs`. Do not run that script. Use the critique the user already has in chat. If none exists, continue without a snapshot. Do your own pass either way.
