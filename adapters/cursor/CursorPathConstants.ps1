...
$script:CursorAdapterMessage = @{
    ...
    CapabilitiesReady       = 'Cursor adapter capabilities reported (skills/rules/hooks/router). Publish + Invoke-SmokeValidate + keyed Uninstall-Toolkit ready (filesystem-only; hooks trust UI out of scope). SDD runtime prepared on sync.'
    ...
    AgentsPublished         = 'Published {0} custom subagent file(s) from core/agents to {1}.'
    AgentsWouldPublish      = 'WhatIf: would publish {0} custom subagent file(s) from core/agents to {1}.'
