...
$script:CodexPathConstant = @{
    ...
    UserScopeDescription           = 'Optional -UserScope also mirrors core/skills to USER discovery. Fixture: InstallRoot/.agents/skills. Live ~/.codex + -AllowUserHome: $HOME/.agents/skills (sync-agent defaults UserScope on for that live pair). Always publishes InstallRoot/skills for Codex $ discovery regardless of UserScope.'
    SmokeTe01Code                  = 'TE01'
    SmokeTe02Code                  = 'TE02'
    SmokeTe03Code                  = 'TE03'
    SmokeTe04Code                  = 'TE04'
