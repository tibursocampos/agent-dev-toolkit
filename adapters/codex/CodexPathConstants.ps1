...
$script:CodexPathConstant = @{
    ...
    UserScopeDescription           = 'Optional -UserScope mirrors core/skills. Fixture InstallRoot (not live ~/.codex): InstallRoot/.agents/skills. Live ~/.codex + -AllowUserHome: real $HOME/.agents/skills. Default publish is plugin-bundled only.'
    SmokeTe01Code                  = 'TE01'
    SmokeTe02Code                  = 'TE02'
    SmokeTe03Code                  = 'TE03'
    SmokeTe04Code                  = 'TE04'
...
$script:CodexPublishMessage = @{
    ...
    RouterDualRootIntro     = 'Codex InstallRoot `{0}` uses dual roots: plugin skills vs InstallRoot rules. Prefer absolute paths below.'
    RouterDualRootNote      = 'Do not resolve skill `_shared` paths under InstallRoot/skills or InstallRoot/rules — they live under the plugin skills TOOLKIT_ROOT. Rules and guardrails live under InstallRoot/rules only.'
