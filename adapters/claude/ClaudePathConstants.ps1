...
$script:ClaudeSettingsJsonConstant = @{
    ...
    HookScriptTraceEmit            = 'emit-trace.ps1'
...
$script:ClaudePublishMessage = @{
    ...
    CoreAgentsMissing       = 'Claude Publish-Agents: core agents source is missing: {0}'
    AgentsPublishedOk       = 'Claude Publish-Agents: published {0} custom subagent file(s) from core/agents to {1}'
    AgentsWhatIfOk          = 'Claude Publish-Agents: WhatIf - would publish {0} custom subagent file(s) to {1}'
