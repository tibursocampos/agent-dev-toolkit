...
$script:OpenCodePublishMessage = @{
    ...
    CoreAgentsMissing     = 'OpenCode Publish-Agents: core agents source is missing: {0}'
    AgentsPublishedOk     = 'OpenCode Publish-Agents: published {0} agent file(s) from core/agents to {1}'
    AgentsWhatIfOk        = 'OpenCode Publish-Agents: WhatIf - would publish {0} agent file(s) to {1}'
...
$script:OpenCodeSmokeMessage = @{
    ...
    Te02CustomAgentsMissing = 'TE02: OpenCode agent ''opencode'' smoke failed - custom agents markdown missing under: {0}'
