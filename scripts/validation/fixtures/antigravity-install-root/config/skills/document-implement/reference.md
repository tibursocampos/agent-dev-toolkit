...
**Not SDD:** do not substitute `features/**/PLAN/PLAN_*.md` (Classic SDD) - those follow `{{TOOLKIT_ROOT}}/skills/_shared/sdd-artifacts/STORAGE.md` and skills `sdd-spec` / `sdd-plan` / `sdd-develop` / `code-review`.
