...
Lean **L0** router for agents after install under `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/antigravity-install-root/config/`. **Pointers only** — do not paste guideline or skill bodies here. Prefer `/<skill>` (or host equivalent); load shared docs on demand.
...
**Enforcement:** `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/antigravity-install-root/config/plugins/agent-dev-toolkit/GUARDRAILS.md`, `sdd-pipeline-guards.mdc`, `core/skills/_shared/sdd-artifacts/SESSION.md`.
...
Published under `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/antigravity-install-root/config/rules/` after sync-agent (source policy under `core/policy/` where applicable).
