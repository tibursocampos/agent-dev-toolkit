...
| Cursor mode (Agent for shell) | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/sdd-artifacts/PIPELINE.md` section Cursor mode |
...
| Add tests for gaps | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/dotnet-guidelines/csharp-patterns.md` |
| Commit | `/commit` |
