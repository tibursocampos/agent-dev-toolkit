...
| Electron security / CSP | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/electron-guidelines/electron-security.md` |
| Electron main / renderer | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/electron-guidelines/electron-main-renderer.md` |
| Electron preload | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/electron-guidelines/electron-preload.md` |
| Electron IPC | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/electron-guidelines/electron-ipc.md` |
| Electron packaging | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/electron-guidelines/electron-packaging.md` |
| Electron delivery checklist | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/electron-guidelines/checklist.md` |
...
| Principles | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/code-guidelines/principles/` |
