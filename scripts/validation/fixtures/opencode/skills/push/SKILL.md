...
|------|----------------------------------------|
| Branch rules | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/rules/branch-validation.mdc` |
| Commit flow | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/developer-common/step-4-commits-pr.md` |
...
→ **STOP** `/push` and **immediately** load `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/open-github-pr/SKILL.md`. Follow it end-to-end (mode, template, body confirmation, **mandatory auto-merge ask**). Do not create the PR inside `/push`.
...
- On **sim** (or explicit `/open-github-pr`): **STOP** this skill and hand off — load and follow `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/open-github-pr/SKILL.md` in the same or new turn (mode feature by default unless user said release). That skill owns template, body confirmation, and auto-merge ask.
