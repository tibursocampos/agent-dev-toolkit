...
Install path after sync: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/sdd-artifacts/STORAGE.md`
...
| **global** | `<path>/features/NNN-slug/` where `<path>` = `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/sdd/<repo-id>/` (or manifest `classic.path`) | `<path>/memory-bank/` |

Use `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/sdd/...` on macOS/Linux when expanding paths in tools.
...
```json
{
  ...
  "repositories": {
    "D:/Source/Repos/MyApp": {
      "classic": {
        "storage_mode": "global",
        "path": "E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/sdd/MyApp"
      }
    }
  }
}
...
2) Global - E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/sdd/<RepositoryName>/ (features/ + memory-bank/ fora do git do projeto; sem alterar .gitignore)
```
