...
Rules: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/rules/conventional-commits.mdc`, `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/rules/branch-validation.mdc`.  
Validator (when installed): `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/format-validators/commit-message-validator.md`.
