...
Load `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/skills/_shared/dotnet-guidelines/clean-architecture.md` before writing code.
...
Per `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/opencode/rules/context-management.mdc`: after detection + requirements + large scaffold, checkpoint at ≥ 40% context; hand off with paths and pending checklist items.
