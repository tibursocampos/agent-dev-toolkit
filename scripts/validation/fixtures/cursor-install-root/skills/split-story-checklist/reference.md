...
3. Do **not** resolve root/flat `PLAN/PLAN_*.md` or `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/sdd/<repo-id>/PLAN/` for execution.
