...
Lazy-load row when applicable: `| Caveman Mode (if active) | E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/caveman/CAVEMAN.md - **{Lite|Full} cap** |`
