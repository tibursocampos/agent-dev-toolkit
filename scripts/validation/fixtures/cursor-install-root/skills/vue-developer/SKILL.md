...
| Vue Composition / SFC | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/vue-guidelines/composition-and-sfc.md` |
| Vue style guide essentials | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/vue-guidelines/style-guide-essentials.md` |
| Vue reactivity | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/vue-guidelines/reactivity.md` |
| Vue routing / state | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/vue-guidelines/routing-and-state.md` |
| Vue testing | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/vue-guidelines/testing.md` |
| Vue accessibility | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/vue-guidelines/accessibility.md` |
| Vue delivery checklist | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/vue-guidelines/checklist.md` |
...
| Frontend tests | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/frontend-guidelines/frontend-testing.md` |
