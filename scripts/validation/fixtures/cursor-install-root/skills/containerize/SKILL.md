...
|------|----------------------------------------|
| DevOps context | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/devops-guidelines/deployment-process.md` |
