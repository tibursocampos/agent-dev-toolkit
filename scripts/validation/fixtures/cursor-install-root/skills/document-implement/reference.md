...
**Not SDD:** do not substitute `features/**/PLAN/PLAN_*.md` (Classic SDD) - those follow `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/sdd-artifacts/STORAGE.md` and skills `sdd-spec` / `sdd-plan` / `sdd-develop` / `code-review`.
