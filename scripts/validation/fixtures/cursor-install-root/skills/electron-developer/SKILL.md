...
| Electron main / renderer | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/electron-guidelines/electron-main-renderer.md` |
| Electron preload | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/cursor-install-root/skills/_shared/electron-guidelines/electron-preload.md` |
