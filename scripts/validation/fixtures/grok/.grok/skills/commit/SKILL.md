...
|------|----------------------------------------|
| Branch rules | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/branch-validation.mdc` |
| Commit format | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/conventional-commits.mdc` |
| Detailed Git flow | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/developer-common/step-4-commits-pr.md` |
| Pre-commit checks | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/developer-common/step-3.5-precommit-validation.md` |
| Message validator (commit-message-validator step) | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/format-validators/commit-message-validator.md` |
