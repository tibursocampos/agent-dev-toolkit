...
Rules: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/conventional-commits.mdc`, `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/branch-validation.mdc`.  
Validator (when installed): `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/format-validators/commit-message-validator.md`.
