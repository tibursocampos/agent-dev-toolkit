...
Lazy-load row when applicable: `| Caveman Mode (if active) | E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/caveman/CAVEMAN.md - **{Lite|Full} cap** |`
