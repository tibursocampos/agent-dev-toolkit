...
Install path after sync: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/caveman/CAVEMAN.md`
...
**Location:** `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/preferences.json`
...
1. Read E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/preferences.json (create default if missing).
