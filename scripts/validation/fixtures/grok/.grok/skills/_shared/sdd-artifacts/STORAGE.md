...
Install path after sync: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/sdd-artifacts/STORAGE.md`
...
| **global** | `<path>/features/NNN-slug/` where `<path>` = `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/<repo-id>/` (or manifest `classic.path`) | `<path>/memory-bank/` |

Use `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/...` on macOS/Linux when expanding paths in tools.
...
```
E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/manifest.json
```
...
```json
{
  ...
  "repositories": {
    "D:/Source/Repos/MyApp": {
      "classic": {
        "storage_mode": "global",
        "path": "E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/MyApp"
      }
    }
  }
}
...
|-------|------------|--------|
| Feature root | `$Cwd/features/NNN-slug/` | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/<repo-id>/features/NNN-slug/` (or manifest path) |
...
2) Global - E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/<RepositoryName>/ (features/ + memory-bank/ fora do git do projeto; sem alterar .gitignore)
```
