...
Paths after sync: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/code-guidelines/`
...
Use `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/dotnet-guidelines/` - not `code-guidelines/languages/dotnet/` until v1.1.
