...
**When:** After PRD draft, before `Write` to resolved feature PRD folder (`features/**/PRD/` or `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/<repo-id>/features/**/PRD/`). Storage: `sdd-artifacts/STORAGE.md`. Language: pt-BR default (`sdd-artifact-language-pt-br.mdc`); validate EN variant if user overrides.
