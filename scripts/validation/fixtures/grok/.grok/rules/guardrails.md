...
1. Read this rule (`E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/.grok/rules/guardrails.md`).
...
3. Read `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/AGENTS.md` § Git and language when mutating git or writing code.
...
See `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/context-management.mdc`. At ≥40% context: pause and recommend new session.
...
Contract: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/caveman/CAVEMAN.md`. Optional narrative compact: `COMPACT.md` (requires user **sim**). Always-on rule: `caveman-mode.mdc`.
