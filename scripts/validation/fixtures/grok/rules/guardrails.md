...
1. Read this rule (`E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/guardrails.md`).
...
3. Read `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/AGENTS.md` Â§ Git and language when mutating git or writing code.
...
See `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/context-management.mdc`. At â‰¥40% context: pause and recommend new session.
