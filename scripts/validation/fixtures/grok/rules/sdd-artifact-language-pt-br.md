...
- Use templates in `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/sdd-spec/reference.md` and `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/sdd-plan/reference.md` (pt-BR variant).
...
Set `artifact_language` to `"en"` in `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/sdd/<repo-id>/manifest.json` when using global storage.
...
After `scripts/sync-cursor.ps1`: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/sdd-artifact-language-pt-br.mdc`
