...
Published under `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/rules/` after sync-agent (source policy under `core/policy/` where applicable).
