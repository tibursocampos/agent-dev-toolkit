...
- Honor `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/grok/skills/_shared/agents/SPAWN.md` (`subagents` native → spawn; `none` / Task unavailable → fallback **in-parent**, never hard-fail; concurrent caps).
