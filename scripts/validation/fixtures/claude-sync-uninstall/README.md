...
Do not point InstallRoot at a live Claude user home from CI. Prefer ephemeral InstallRoot for merge smoke so this seed stays intact.
...
# Assert merge behavior + seed contract (does not permanently overwrite seed when using ephemeral roots)
