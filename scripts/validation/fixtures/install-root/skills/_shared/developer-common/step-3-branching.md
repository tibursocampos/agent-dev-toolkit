...
Canonical rule: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/rules/branch-validation.mdc` (overrides this file if they differ).
