...
1. **Read** `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/skills/_shared/code-guidelines/principles/architecture-selection.md` (camada A — WHEN).
