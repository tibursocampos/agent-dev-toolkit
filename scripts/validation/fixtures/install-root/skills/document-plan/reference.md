...
Per `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/rules/context-management.mdc`:
...
| Skill | Use |
|-------|-----|
| `plan` / `sdd-develop` | Feature delivery PRD/PLAN - `PRD/`, `PLAN/`, or `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/<repo-id>/` per `STORAGE.md` |
