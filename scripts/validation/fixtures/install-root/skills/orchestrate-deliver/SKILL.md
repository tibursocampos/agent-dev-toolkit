...
| CONTINUITY / FEATURE templates | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/skills/_shared/templates/features/` |
| Spec contract | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/skills/sdd-spec/SKILL.md` (+ `reference.md` as needed) |
| Plan contract | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/skills/sdd-plan/SKILL.md` (+ `reference.md` as needed) |
