...
| Example (global) | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/acme-payments-api/features/002-exportacao-perfil/US01/PRD/002_exportacao_perfil_usuario.md` |
...
After choosing storage, write `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/<repo-id>/manifest.json` with `artifact_language`: `pt-BR` (default) or `en` (override).
