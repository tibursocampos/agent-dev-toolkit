...
Install path after sync: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/skills/_shared/sdd-artifacts/STORAGE.md`
...
| **global** | `<path>/features/NNN-slug/` where `<path>` = `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/<repo-id>/` (or manifest `classic.path`) | `<path>/memory-bank/` |

Use `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/...` on macOS/Linux when expanding paths in tools.
...
2. **Always** require these patterns in repository mode:
   ...
   | `/memory-bank/` | Orchestrated Delivery memory-bank (entire tree; local agent workflow - not committed) |
...
```
E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/manifest.json
```
...
```json
{
  ...
  "repositories": {
    "D:/Source/Repos/MyApp": {
      "classic": {
        "storage_mode": "global",
        "path": "E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/MyApp"
      }
    }
  }
}
...
|-------|------------|--------|
| Feature root | `$Cwd/features/NNN-slug/` | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/<repo-id>/features/NNN-slug/` (or manifest path) |
...
2) Global - E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/<RepositoryName>/ (features/ + memory-bank/ fora do git do projeto; sem alterar .gitignore)
```
