...
Install path after sync: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/skills/_shared/caveman/CAVEMAN.md`
...
**Location:** `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/preferences.json`
...
| Orchestrated Delivery agent prompts | Receipt schema when mode ON |

### Canonical Step -1 block (copy into skills)

```
### Step -1b - Caveman Mode
1. Read E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/install-root/sdd/preferences.json (create default if missing).
