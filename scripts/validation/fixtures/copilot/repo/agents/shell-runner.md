...
Roster: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/copilot/repo/skills/_shared/agents/ROSTER.md`.
Spawn contract: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/copilot/repo/skills/_shared/agents/SPAWN.md`.
