...
| FastAPI | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/fastapi.md` |
| Flask | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/flask.md` |
| Architecture (hub / structure) | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/architecture.md` |
...
| pytest | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/pytest.md` |
| Packaging / pyproject | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/packaging-pyproject.md` |
| Typing | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/typing.md` |
| Async pitfalls | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/async-pitfalls.md` |
| Style / principles | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/google-style.md`, `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/python-guidelines/principles.md` |
...
Before push/PR, run `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/developer-common/step-7-checklist.md` and confirm FastAPI/Flask/pytest guidance used as needed.
