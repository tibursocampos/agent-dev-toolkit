...
Install path after sync: `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/developer-common/`
...
developer-common/
├── GUIDE.md                         # This file
├── subagent-first.md                # Subagent-first policy for *-developer (SPAWN + fallback)
...
**Subagent-first (`*-developer`):** follow `subagent-first.md` (mandatory pointer to `SPAWN.md` + capability `subagents`). Do not inline that policy in every stack skill.
...
Follow `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/skills/_shared/developer-common/step-3-branching.md`.
```
...
| Step | Rule / skill |
|------|----------------|
| 3 | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/rules/branch-validation.mdc` |
| 4 | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/rules/conventional-commits.mdc`, `commit` skill |
