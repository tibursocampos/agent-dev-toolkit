...
```
E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/sdd/manifest.json
```
...
|-------|------------|--------|
| Feature root | `$Cwd/features/NNN-slug/` | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/zcode-install-root/sdd/<repo-id>/features/NNN-slug/` (or manifest path) |
