...
```
E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/sdd/sessions\
```
...
3. sessionsDir = E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/sdd/sessions
...
`-PlanPath` must exist and resolve under `-RepoPath` or under `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/sdd/` (global classic).
