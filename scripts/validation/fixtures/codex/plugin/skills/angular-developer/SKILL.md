...
| Angular style / structure | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/plugin/skills/_shared/angular-guidelines/style-and-structure.md` |
| Angular standalone / templates | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/plugin/skills/_shared/angular-guidelines/standalone-and-templates.md` |
| Angular Signals / state | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/plugin/skills/_shared/angular-guidelines/signals-and-state.md` |
| Angular DI / routing / forms | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/plugin/skills/_shared/angular-guidelines/di-routing-forms.md` |
| Angular RxJS lifecycle | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/plugin/skills/_shared/angular-guidelines/rxjs-lifecycle.md` |
| Angular testing | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/plugin/skills/_shared/angular-guidelines/testing.md` |
| Angular delivery checklist | `E:/Source/Repos/agent-dev-toolkit/scripts/validation/fixtures/codex/plugin/skills/_shared/angular-guidelines/checklist.md` |
