...
$script:ToolkitConstant = @{
    ...
    InvokeAuthorshipGitNotesScriptRelativePath   = 'scripts/trace/Invoke-AuthorshipGitNotes.ps1'
    AuthorshipGitNotesGuideRelativePath          = 'docs/guides/09-authorship-git-notes.md'
    AuthorshipGitNotesRefName                    = 'toolkit-authorship'
    AuthorshipGitNotesDefaultEnabled             = $false
    AuthorshipGitNotesStatusDisabled             = 'disabled'
    AuthorshipGitNotesStatusSkipped              = 'skipped_default_off'
    AuthorshipGitNotesStatusWritten              = 'written'
    AuthorshipGitNotesStatusShown                = 'shown'
    AuthorshipGitNotesExitOk                     = 0
    AuthorshipGitNotesExitFail                   = 2
    AuthorshipGitNotesHonestyRelativePath        = 'adapters/_shared/trace-emitter-honesty.md'
...
$script:ToolkitMessage = @{
    ...
    UserProfileUnavailable             = 'User home is not set (USERPROFILE / HOME / UserProfile folder); cannot validate InstallRoot safety.'
    InstallRootUnderUserProfileBlocked = 'InstallRoot resolves under user home ({0}). Refuse write/smoke targets in the user profile unless -AllowUserHome is set. Path: {1}'
    ...
    InstallRootReparseEmptyFinalPath   = 'Final path resolution returned an empty path.'
    InstallRootUnixSymlinkResolveFailed = 'Unix symlink resolution failed for existing path.'
