...
These pages are the operator map of the **42** invocable skills. Counts and ids come from `core/skills/*/SKILL.md` and `core/skills/_shared/skills-catalog/CATALOG.md`. Shared folders under `core/skills/_shared/` are packs, not skills.
...
| [05 Review and quality](05-review-and-quality.md) | Review modes, stack tests, coverage, refactor, performance, build repair | `code-review`, `run-tests`, `test-coverage`, `refactor`, `performance-profile`, `repair-dotnet-build` |
...
| [09 Every skill](09-every-skill.md) | One section per skill id, with the session that expands it | all 42 |
